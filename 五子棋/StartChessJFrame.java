...
public class StartChessJFrame extends JFrame {  
  ...
  //重新开始，退出，和悔棋菜单项   定义顺序无关紧要
  public StartChessJFrame(){  
      this.setTitle("姜兴琪制作");//设置标题   
      ...
      //将三个菜单项（关系到顺序）添加到菜单上   
      sysMenu.add(startMenuItem);  //第一个
      sysMenu.add(exitMenuItem);  //第二个
      sysMenu.add(backMenuItem);  //第三个 
      //初始化按钮事件监听器内部类   
      ...
      this.menuBar.add(sysMenu);//将系统菜单添加到菜单栏上   
